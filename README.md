...
| 0004 | [Implement Queue using Arrays](./DSA/Recursion/implement-queue-using-arrays) | [JAVA](./DSA/Recursion/implement-queue-using-arrays/solution.java) | 🟢 Easy | `DSA` / `Recursion` |
| 0005 | [Implement queue using Linkedlist](./DSA/Linked-List/implement-queue-using-linkedlist) | [JAVA](./DSA/Linked-List/implement-queue-using-linkedlist/solution.java) | 🟢 Easy | `DSA` / `Linked-List` |
| 0006 | [Implement Queue using Stack](./DSA/Stack-Queue/implement-queue-using-stack) | [JAVA](./DSA/Stack-Queue/implement-queue-using-stack/solution.java) | 🟢 Easy | `DSA` / `Stack-Queue` |
...
| 0010 | [Next Greater Element](./DSA/General/next-greater-element) | [Solution-2](./DSA/General/next-greater-element/Solution-2.java) [JAVA](./DSA/General/next-greater-element/solution.java) | 🟡 Medium | `DSA` |
| 0011 | [Next Greater Element - 2](./DSA/General/next-greater-element-2) | [JAVA](./DSA/General/next-greater-element-2/solution.java) | 🟡 Medium | `DSA` |
